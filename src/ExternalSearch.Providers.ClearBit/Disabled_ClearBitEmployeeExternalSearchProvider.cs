...
namespace CluedIn.ExternalSearch.Providers.ClearBit
{
    ...
    public class ClearBitEmployeeExternalSearchProvider : ExternalSearchProviderBase
    {
        /**********************************************************************************************************
         * CONSTRUCTORS
         **********************************************************************************************************/
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClearBitEmployeeExternalSearchProvider" /> class.
        /// </summary>
        public ClearBitEmployeeExternalSearchProvider()
            : base(Constants.ExternalSearchProviders.ClearBitEmployeeId, EntityType.Person)
        {
        }
