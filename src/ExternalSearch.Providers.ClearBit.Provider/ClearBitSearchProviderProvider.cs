...
{
    public class ClearBitSearchProviderProvider : ProviderBase, IExtendedProviderMetadata, IExternalSearchProviderProvider
    {
        ...
        {
            if (jobData is ClearBitExternalSearchJobData result)
            {
